...
image_mode_bindings = {
	...
	}, -- show next image
	{
		"MBTN_RIGHT",
		function()
			mp.command("script-binding drag-to-pan")
		end,
	},
	{
		"MBTN_MID",
	...
	},
	{
		"MBTN_LEFT",
		function()
			mp.command("script-binding pan-follows-cursor")
		end,
	},
	{
		"MBTN_LEFT_DBL",
	...
	},
	{
		"WHEEL_UP",
		function()
			mp.command("script-message cursor-centric-zoom 0.1")
		end,
	},
	{
		"WHEEL_DOWN",
	...
	},
	{
		"ctrl+DOWN",
		function()
			mp.command("script-message pan-image y -0.1 yes yes")
		end,
		"repeatable",
	},
	{
	...
	},
	{
		"ctrl+RIGHT",
		function()
			mp.command("script-message pan-image x -0.1 yes yes")
		end,
		"repeatable",
	},
	{
	...
	},
	{
		"alt+DOWN",
		function()
			mp.command("script-message pan-image y -0.01 yes yes")
		end,
		"repeatable",
	},
	{
	...
	},
	{
		"alt+RIGHT",
		function()
			mp.command("script-message pan-image x -0.01 yes yes")
		end,
		"repeatable",
	},
	{
	...
	},
	{
		"ctrl+0",
		function()
			mp.command("no-osd set video-pan-x 0; no-osd set video-pan-y 0; no-osd set video-zoom 0")
		end,
	},
	{
		"+",
		function()
			mp.command("add video-zoom 0.5")
		end,
		"repeatable",
	},
	{
		"-",
		function()
			mp.command("add video-zoom -0.5; script-message reset-pan-if-visible")
		end,
		"repeatable",
	},
	{
	...
	},
	{
		"e",
		function()
			mp.command("script-message equalizer-toggle")
		end,
	},
	{
		"alt+e",
		function()
			mp.command("script-message equalizer-reset")
		end,
	},
	{
		"h",
		function()
			mp.command('no-osd vf toggle hflip; show-text "Horizontal flip"')
		end,
	},
	{
		"v",
		function()
			mp.command('no-osd vf toggle vflip; show-text "Vertical flip"')
		end,
	},
	{
		"r",
		function()
			mp.command('script-message rotate-video 90; show-text "Clockwise rotation"')
		end,
	},
	{
		"R",
		function()
			mp.command('script-message rotate-video -90; show-text "Counter-clockwise rotation"')
		end,
	},
	{
		"alt+r",
		function()
			mp.command('no-osd set video-rotate 0; show-text "Reset rotation"')
		end,
	},
	{
		"d",
		function()
			mp.command("script-message ruler")
		end,
	},
	{
		"a",
		function()
			mp.command("cycle-values scale nearest ewa_lanczossharp")
		end,
	},
	{
		"c",
		function()
			mp.command("cycle icc-profile-auto")
		end,
	},
	{
		"A",
		function()
			mp.command('cycle-values video-aspect-override "-1" "no"')
		end,
	},
	{
		"p",
		function()
			mp.command("script-message force-print-filename")
		end,
	},
}
