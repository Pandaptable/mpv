		...
		for x = 1, W do
			...
			for a_x = -1, 1 do
				for a_y = -1, 1 do
					local t_x = x + a_x
					local t_y = y + a_y
					if t_x >= 1 and t_x <= W and t_y >= 1 and t_y <= H and gField[t_x][t_y].is_mine then
...
function toggle_show()
	if gHidden then
		...
		mp.add_forced_key_binding("left", "mines-left", function()
			move(-1, 0)
		end, REP)
		mp.add_forced_key_binding("right", "mines-right", function()
			move(1, 0)
		end, REP)
		mp.add_forced_key_binding("up", "mines-up", function()
			move(0, -1)
		end, REP)
		mp.add_forced_key_binding("down", "mines-down", function()
			move(0, 1)
		end, REP)
